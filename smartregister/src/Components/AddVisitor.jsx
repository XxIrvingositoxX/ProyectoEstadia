                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left mr-5">
                                    ...
                                    <form className="max-w-md mx-auto mt-5 mb-5 w-full">
                                        <div className="relative z-0 w-full mb-5 group">
                                            <input type="text" name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 peer" placeholder=" " required />
                                        ...
                                        <div className="relative z-0 w-full mb-5 group">
                                            <input type="text" name="floating_password" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 peer" placeholder=" " required />
                                        ...
                                        <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-600">Tipo de identificación</label>
                                        <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg block w-full p-2.5">
                                            <option defaultValue="INE">INE</option>
                                            <option value="Conducir">Licencia de conducir</option>
                                            <option value="Empresa">Identificación de la empresa</option>
                                            <option value="Otro">Otro</option>
                                        </select>
                                        <div className="relative z-0 w-full mb-5 mt-4 group">
                                            <input type="text" name="floating_password" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 peer" placeholder=" "/>
