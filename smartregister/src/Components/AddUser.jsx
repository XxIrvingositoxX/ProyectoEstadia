                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left mr-5 p-4">
                                    ...
                                    <form className="max-w-md mx-auto mt-5 mb-5 w-full">
                                        ...
                                        <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg block w-full p-2.5">
                                            <option value="US">Ama de llaves</option>
                                            <option value="CA">BellBoys</option>
                                            <option value="FR">AyB</option>
                                            <option value="DE">Mantenimiento</option>
                                        </select>
                                        <div className="relative z-0 w-full mb-5 group mt-4">
                                            <input type="text" name="repeat_password" id="floating_repeat_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-gray-300 peer" placeholder=" " required />
